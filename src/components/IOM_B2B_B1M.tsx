...
const IOM_B2B_B1M: React.FC<IOM_B2B_B1MProps> = ({ onBackToSearch, onNavigate }) => {
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900">IOM B2B B1M</h1>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="text-right">
              <p className="text-sm text-gray-500">Application Submitted: May 20, 2025</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-8">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-2">Submission Date</label>
                  <div className="bg-gray-100 px-4 py-3 rounded-lg">
